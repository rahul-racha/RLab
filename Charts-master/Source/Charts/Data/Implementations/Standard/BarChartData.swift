...
open class BarChartData: BarLineScatterCandleBubbleChartData
{
    ...
    /// Previously set x-values of entries will be overwritten. Leaves space between bars and groups as specified by the parameters.
    ...
    /// - parameter barSpace: The space between individual bars in values (not pixels) e.g. 0.1f for bar width 1f
